...
def serializedATN():
    return [
        ...
        1,0,0,0,0,11,1,0,0,0,0,13,1,0,0,0,1,15,1,0,0,0,3,18,1,0,0,0,5,26,
        ...
        4,1,0,0,0,24,22,1,0,0,0,25,27,7,2,0,0,26,25,1,0,0,0,27,28,1,0,0,
        0,28,26,1,0,0,0,28,29,1,0,0,0,29,6,1,0,0,0,30,31,5,40,0,0,31,8,1,
        0,0,0,32,33,5,41,0,0,33,10,1,0,0,0,34,35,5,62,0,0,35,12,1,0,0,0,
        36,38,7,3,0,0,37,36,1,0,0,0,38,39,1,0,0,0,39,37,1,0,0,0,39,40,1,
        0,0,0,40,41,1,0,0,0,41,42,6,6,0,0,42,14,1,0,0,0,4,0,22,28,39,1,6,
        0,0
    ]
...
class ExprLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "IF", "ID", "NUM", "PAR_IZQ", "PAR_DER", "MAYOR", "WS" ]

    ruleNames = [ "IF", "ID", "NUM", "PAR_IZQ", "PAR_DER", "MAYOR", "WS" ]
